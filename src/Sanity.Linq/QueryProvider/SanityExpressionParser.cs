    ...
    : ExpressionVisitor
{
        ...
        switch (e.Method.Name)
        {
            ...
            case "Contains":
            {
                ...
                if (collectionExpr != null && valueExpr != null)
                {
                    ...
                    if (collectionExpr is MemberExpression && !(valueExpr is MemberExpression))
                    {
                ...
                )
                {
                    ...
                    if (simplifiedValue is ConstantExpression c2)
                    {
            ...
            case "Where":
            {
                ...
                //Arg 1: Query / lambda
                if (e.Arguments[1] is UnaryExpression { Operand: LambdaExpression l })
                {
            ...
            case "Include":
            {
                ...
                // Arg 1: Field to join
                if (e.Arguments[1] is UnaryExpression { Operand: LambdaExpression { Body: MemberExpression { Member.MemberType: MemberTypes.Property } } l })
                {
                    var fieldPath = TransformOperand(l.Body);
                    var propertyType = l.Body.Type;
                    var targetName = fieldPath.Split('.', '>').LastOrDefault();
    ...
    protected string TransformOperand(Expression e)
    {
        ...
        if (e is ConstantExpression c)
        {
            ...
            if (c.Type == typeof(DateTimeOffset) || c.Type == typeof(DateTimeOffset?))
            {
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var isNestedSanityReferenceType = nestedSanityReferenceProperty != null;
                    ...
                    else
                    {
                        ...
                        var isNestedListOfSanityReferenceType = nestedListOfSanityReferenceType != null;
                        ...
                        else
                        {
                            ...
                            var isListOfSanityImages = listOfSanityImagesType != null;
    ...
    internal class SanityQueryBuilder
    {
        ...
        private Dictionary<string, string> GroqTokens = new()
        {
